...
def interactive_wizard():
    ...
    out = input("Destino do CSV (ENTER= music/data/influences_origins.csv): ").strip() or "dados/influences_origins.csv"
    sidecar = input("Sidecar de arestas (ENTER= music/data/influences_edges.csv; vazio= não criar): ").strip() or "dados/influences_edges.csv"
