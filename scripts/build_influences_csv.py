...
Saída (por omissão): music/data/influences_origins.csv  [sep=';']
Colunas: Parent;Child;Fonte;Peso;Confianca;Raiz

Uso:
  python scripts/build_influences_csv.py \
      --wikipedia-csv music/data/graficos_generos.csv \
      --out music/data/influences_origins.csv \
...
def main():
    ...
    ap.add_argument("--out", default="music/data/influences_origins.csv", help="Caminho de saída")
