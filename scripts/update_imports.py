...
SUBS = {
    ...
    "from services.music.spotify.auth import":        "from services.music.spotify.auth import",
    "from services.music import spotify as spotify.auth":             "from services.music import spotify as spotify.auth",

    "from services.music.spotify.lookup import":       "from services.music.spotify.lookup import",
    "from services.music import spotify as spotify.lookup":            "from services.music import spotify as spotify.lookup",

    "from services.music.spotify.radio import":        "from services.music.spotify.radio import",
    "from services.music import spotify as spotify.radio":             "from services.music import spotify as spotify.radio",

    "from services.music.spotify.push import":         "from services.music.spotify.push import",
    "from services.music import spotify as spotify.push":              "from services.music import spotify as spotify.push",

    "from services.music.spotify.session_push import": "from services.music.spotify.session_push import",
    "from services.music import spotify as spotify.session_push":      "from services.music import spotify as spotify.session_push",

    "from services.music.spotify.genres import":       "from services.music.spotify.genres import",
    "from services.music import spotify as spotify.genres":            "from services.music import spotify as spotify.genres",

    # novos helpers
    "from services.music.spotify.search import":       "from services.music.spotify.search import",
    "from services.music import spotify as spotify.search":            "from services.music import spotify as spotify.search",

    "from services.music.spotify.albums import":       "from services.music.spotify.albums import",
    "from services.music import spotify as spotify.albums":            "from services.music import spotify as spotify.albums",

    # core antigo renomeado
    "from services.music.spotify.core import":         "from services.music.spotify.core import",
    "from services.music import spotify as spotify.core":              "from services.music import spotify as spotify.core",
